...
3. **Save/Load** — The system automatically restores active tickets from `data/parking_data.txt` on startup, and automatically saves when you exit using option `6`.
